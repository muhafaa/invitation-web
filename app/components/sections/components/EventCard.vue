<template>
  <div
    class="wedding-card overflow-hidden bg-white/80 backdrop-blur-sm hover:shadow-xl transition-all duration-300"
  >
    <div class="p-6 md:p-8">
      <div class="flex items-center gap-3 mb-6">
        <div class="flex p-3 bg-navy-100 rounded-full">
