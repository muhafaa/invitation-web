  ...
  <div class="space-y-8 transition-all duration-1000 opacity-100 translate-y-0">
    ...
    <div class="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div class="p-6 md:p-8">
            ...
            <form @submit.prevent="handleSubmit" class="space-y-6">
              ...
              <div class="space-y-2">
                ...
                <div class="space-y-3">
                  <label
                    class="flex items-center gap-3 p-3 border border-navy-200 rounded-lg cursor-pointer hover:bg-navy-50 transition-colors duration-300"
                  >
                    <input
              ...
              <Transition name="slide-down">
                <div v-if="formData.attendance === 'hadir'" class="space-y-2">
                  <label
                    for="guestCount"
                    class="block text-navy-700 font-medium"
                  >
                    Jumlah Tamu *
                  </label>
                  <select
      ...
      <div class="space-y-6">
        <!-- Statistics -->
        <div
          class="wedding-card bg-gradient-to-br from-navy-800 to-navy-900 text-white"
        >
        ...
        <div class="wedding-card bg-white/80 backdrop-blur-sm">
          <div class="p-6">
            <h3
              class="text-lg font-serif text-navy-800 mb-4 flex items-center gap-2"
            >
            ...
            <div class="space-y-3 max-h-64 overflow-y-auto">
              <div
                ...
                class="text-navy-500 text-sm text-center py-4"
              >
              ...
              >
                <div>
                  <p class="font-medium text-navy-800 text-sm">
                    {{ guest.name }}
                  </p>
...
const guests = ref<typeof mockGuests.value>([])
const formData = ref({
  name: '',
  attendance: '',
  guestCount: '',
...
function showToast(title: string, description: string, _variant = 'default') {
...
async function handleSubmit() {
  ...
  if (
    formData.value.attendance === 'hadir' &&
    (!formData.value.guestCount || +formData.value.guestCount < 1)
  ) {
  ...
  try {
    const guestData = {
      ...
      guestCount:
        formData.value.attendance === 'hadir'
          ? parseInt(formData.value.guestCount)
          : 0,
    }
