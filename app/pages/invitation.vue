<template>
  ...
  >
    <!-- Floating Header -->
    <header
      class="fixed top-0 left-0 right-0 bg-white/80 backdrop-blur-md shadow-sm border-b border-navy-100 z-40"
    >
      <div class="container mx-auto px-4 py-3">
        <div class="text-center">
          ...
          <p class="text-xs text-navy-500">
            {{ weddingDataComputed?.ceremony.akad.date }}
          </p>
        </div>
      </div>
      <!-- Scroll Progress Bar -->
    ...
    <main class="pt-20">
      ...
      <!-- Section Divider -->
      <div
        class="h-20 bg-gradient-to-b from-transparent via-navy-100/30 to-transparent"
      ></div>
      ...
      >
        <div class="max-w-5xl mx-auto w-full">
          <SectionsIslamicQuote :quote="weddingDataComputed?.islamicQuote" />
        </div>
      </ScrollSection>

      <!-- Section Divider -->
      <div
        class="h-20 bg-gradient-to-b from-transparent via-slate-100/50 to-transparent"
      ></div>
      ...
      >
        <div class="max-w-7xl mx-auto w-full">
          <SectionsPhotoCarousel :photos="weddingDataComputed?.gallery" />
        </div>
      </ScrollSection>

      <!-- Section Divider -->
      <div
        class="h-20 bg-gradient-to-b from-transparent via-navy-50/40 to-transparent"
      ></div>
      ...
      >
        <div class="max-w-7xl mx-auto w-full">
          <SectionsCoupleProfiles :couple="weddingDataComputed?.couple" />
        </div>
      </ScrollSection>

      <!-- Section Divider -->
      <div
        class="h-20 bg-gradient-to-b from-transparent via-blue-50/40 to-transparent"
      ></div>
      ...
      >
        <div class="max-w-7xl mx-auto w-full">
          <SectionsCeremonyDetails :ceremony="weddingDataComputed?.ceremony" />
        </div>
      </ScrollSection>
    ...
    <footer class="bg-navy-800 text-white py-12">
      <div class="container mx-auto px-4 text-center">
        ...
        <div class="max-w-2xl mx-auto text-navy-300 leading-relaxed mb-6">
          <p>
            Kehadiran dan doa restu dari keluarga dan sahabat merupakan anugerah
            terindah bagi kami. Semoga Allah SWT senantiasa memberkahi langkah
            kami.
          </p>
        </div>
    ...
    <button
      v-if="showScrollTop"
      @click="scrollToTop"
      class="fixed flex bottom-6 right-6 z-50 bg-navy-800 hover:bg-navy-600 text-white p-3 rounded-full shadow-lg transition-all duration-300 hover:scale-110"
    >
...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'Join us in celebrating our special wedding day',
    },
  ],
})
</script>
