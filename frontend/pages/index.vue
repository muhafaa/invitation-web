<template>
  <div class="min-h-screen relative overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-navy-100">
    <!-- Background Pattern -->
    <div class="absolute inset-0 opacity-10">
      <div class="absolute top-10 left-10 w-20 h-20 border border-navy-300 rounded-full"></div>
      <div class="absolute top-32 right-20 w-16 h-16 border border-navy-200 rounded-full"></div>
      <div class="absolute bottom-20 left-1/4 w-12 h-12 border border-navy-300 rounded-full"></div>
      <div class="absolute bottom-40 right-10 w-24 h-24 border border-navy-200 rounded-full"></div>
    </div>
    ...
    <div class="relative min-h-screen flex items-center justify-center p-4">
      ...
      >
        <!-- Envelope Back -->
        <div class="relative w-80 h-96 md:w-96 md:h-[28rem] bg-gradient-to-br from-navy-700 to-navy-900 rounded-lg shadow-2xl">
          ...
          >
            <!-- Envelope Seal -->
            <div class="absolute bottom-4 left-1/2 transform -translate-x-1/2 w-12 h-12 bg-gold-400 rounded-full flex items-center justify-center shadow-lg">
          ...
          >
            <div class="p-6 md:p-8 h-full flex flex-col justify-center items-center text-center relative">
              
              <!-- Decorative Border -->
              <div class="absolute inset-2 border-2 border-navy-200 rounded-lg opacity-50"></div>
              <div class="absolute inset-4 border border-navy-100 rounded-lg opacity-30"></div>
              
              <!-- Content -->
              <div class="relative z-10 space-y-6">
                <Icon name="lucide:mail" class="w-8 h-8 text-navy-600 mx-auto opacity-80" />
                
                <div class="space-y-2">
                  <p class="text-sm text-navy-500 font-medium tracking-wider uppercase">Undangan Pernikahan</p>
                ...
                <div class="space-y-4">
                  ...
                  <div class="space-y-2 text-navy-600">
                    ...
                    <p class="text-lg font-semibold text-navy-800">{{ guestName }}</p>
                  </div>
                </div>
                ...
                <p class="text-xs text-navy-400 mt-4">Mohon maaf apabila ada kesalahan nama dan gelar</p>
              </div>
            </div>
          </div>
        </div>
...
// Use weddingData directly since it's already available
const weddingData = weddingDataRef
...
useHead({
  ...
  meta: [
    ...
    { property: 'og:description', content: 'Join us in celebrating our special day' }
  ]
})
</script>