<template>
  <div class="space-y-8 transition-all duration-1000 opacity-100 translate-y-0">
    ...
    <!-- Couple Profiles -->
    <div class="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto relative">
      <!-- Bride -->
      <div class="animate-slide-in-left">
        <ProfileCard :person="couple?.bride" :is-groom="false" />
      </div>

      <!-- Heart Connector - Desktop Only -->
      <div class="hidden md:flex absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
        <div class="bg-white rounded-full p-4 shadow-lg border-4 border-navy-100">
          <Icon name="lucide:heart" class="w-8 h-8 text-red-500" />
        </div>
      </div>

      <!-- Heart Connector - Mobile Only -->
      <div class="md:hidden flex justify-center -my-4 z-10 relative">
        <div class="bg-white rounded-full p-3 shadow-lg border-4 border-navy-100">
      ...
      <div class="animate-slide-in-right">
        <ProfileCard :person="couple?.groom" :is-groom="true" />
      </div>
    </div>

    <!-- Love Story Section -->
    <div class="max-w-3xl mx-auto wedding-card bg-gradient-to-br from-navy-800 to-navy-900 text-white">
      <div class="p-8 md:p-12 text-center space-y-6">
        ...
        <div class="space-y-4 text-navy-100 leading-relaxed">
          <p>
          ...
          <p class="text-sm text-navy-300 italic">
            - QS. Adz-Dzaariyat: 49
          </p>
        </div>
      </div>
