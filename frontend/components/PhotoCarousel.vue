  ...
  <div class="space-y-8 transition-all duration-1000 opacity-100 translate-y-0">
    ...
    <div class="wedding-card overflow-hidden bg-white/80 backdrop-blur-sm">
      <div class="relative aspect-[4/3] md:aspect-[16/9]">
        ...
        <button
          @click="goToPrevious"
          class="absolute left-4 top-1/2 -translate-y-1/2 bg-white/20 hover:bg-white/30 backdrop-blur-sm text-white border border-white/20 p-2 rounded-full transition-all duration-300"
        >
        ...
        <button
          @click="goToNext"
          class="absolute right-4 top-1/2 -translate-y-1/2 bg-white/20 hover:bg-white/30 backdrop-blur-sm text-white border border-white/20 p-2 rounded-full transition-all duration-300"
        >
        ...
        <button
          ...
          class="absolute top-4 right-4 bg-white/20 hover:bg-white/30 backdrop-blur-sm text-white border border-white/20 p-2 rounded-full transition-all duration-300"
        >
        ...
        <!-- Photo Counter -->
        <div class="absolute bottom-4 left-4 bg-white/20 backdrop-blur-sm text-white px-3 py-1 rounded-full text-sm">
      ...
      <div class="flex gap-2 overflow-x-auto pb-2 max-w-full">
        <button
          ...
          :class="{
            ...
            'border-transparent opacity-70 hover:opacity-100 hover:scale-105': index !== currentIndex
          }"
        >
          <img
            :src="photo"
